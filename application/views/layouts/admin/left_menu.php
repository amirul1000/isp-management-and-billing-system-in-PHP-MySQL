...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="customer"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/customer/index'); ?>"><i class="icon_table"></i>Customer</a></li>
        <li <?php if($this->router->fetch_class()=="bill"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/bill/index'); ?>"><i class="icon_table"></i>Bill</a></li>
